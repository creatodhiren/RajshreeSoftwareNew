<div class="content" >
   ...
   <a href="<?php echo base_url(); ?>Add_Payment" class="btn btn-success" ><i class="fa fa-plus"></i>  &nbsp;Add Payment</a>
   <br>
   <?php
      if($this->session->flashdata('payment')) {
      $message = $this->session->flashdata('payment');
      ...
      <div class="span12">
         <div class="grid simple ">
            <div class="grid-title">
               <h4>All Payment <span class="semi-bold">List</span></h4>
               <div class="tools">
            ...
            <div class="grid-body table-responsive">
                ...
                <input type="submit" class="btn btn-default" name="submit" value="Search" onclick="search_payment_list()">
                </div>
                </div>
                  ...
                  <tbody id="example3">
                    ...
                    // print_r($paymentList);
                     ...
                     <tr>
                        ...
                        <td><b style="color:orange;"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $final=$value['after_tax_amount']; ?></b></td>
                        <td><b style="color:green;"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $paid=$value['totsum']; ?></b></td>
                        <td><b style="color:red;"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $final-$paid; ?></b></td>
                        <td>
                           <span class="btn btn-warning" onclick="paymentlisting('<?php echo base64_encode($value['invoice_no']); ?>');" data-toggle="modal" data-target="#myModal" title="Payment History"><i class="fa fa-eye" aria-hidden="true"></i></span>
                        </td>
                     </tr>
                     <?php
                     }
...
$.ajax({
  type: "POST",
  url: base_url+"Vendor/getUserListBySearchPaymentList",
