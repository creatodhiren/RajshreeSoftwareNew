...
<div class="content">
   ...
   <a href="<?php echo base_url(); ?>Add_Color_Option" class="btn btn-success" ><i class="fa fa-plus"></i>  &nbsp;Add Option</a>
   <br>
   <?php
                     ...
                     <tr class="odd gradeX">
                        ...
                        <td>
                           <?php $id=base64_encode($lis['option_id']); ?>
                        	<a href="<?php echo base_url(); ?>Edit_Color_Option/<?php echo $id; ?>"><span class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></span></a>
